...
public class ProcurementDoneRecyclerAdapter extends RecyclerView.Adapter<ProcurementDoneRecyclerAdapter.RoomViewHolder> implements Filterable {
    ...
    public ProcurementDoneRecyclerAdapter(Context context, List<ProcurementDAO> dataList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ProcurementDoneRecyclerAdapter.RoomViewHolder holder, int position) {
        ...
        holder.mMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view){
                ...
                inflater.inflate(R.menu.procurement_done, menuBuilder);
