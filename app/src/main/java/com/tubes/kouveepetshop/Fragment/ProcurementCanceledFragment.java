...
import com.tubes.kouveepetshop.RecyclerAdapter.ProcurementCanceledRecyclerAdapter;
...
public class ProcurementCanceledFragment extends Fragment {
    ...
    public ProcurementCanceledFragment() {
    ...
    public void load(){
        ...
        Call<List<ProcurementDAO>> call = apiService.getAllByStatusProcurement("Batal");
    ...
    private void generateDataList(List<ProcurementDAO> list) {
        recyclerAdapter = new ProcurementCanceledRecyclerAdapter(getContext(),list, this);
    ...
    public void Restore(final String id) {
        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
        Call<ProcurementDAO> call = apiService.returnProcurement(id);
