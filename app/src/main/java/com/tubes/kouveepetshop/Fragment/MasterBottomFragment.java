...
public class MasterBottomFragment extends BottomSheetDialogFragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_master_bottom_sheet, container, false);
        ...
        Toast.makeText(getContext(), "MenuMaster : "+menuMaster, Toast.LENGTH_SHORT).show();

        twNameTitle.setText(name);

        if(menuMaster.equalsIgnoreCase("Service"))
        {
            ...
            btnDelete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    deleteService(view,id);
                }
            });
        }
        else if(menuMaster.equalsIgnoreCase("PetSize"))
        {
            twNameTitle.setText(name);
            btnEdit.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    private void getService()
    {
        ...
        Call<List<ServiceDAO>> get = apiService.getByService(id);
    ...
    private void deleteService(View v, final String sId) {
                ...
                .setPositiveButton("HAPUS",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
                                Call<ServiceDAO> delete = apiService.deleteService(sId);
